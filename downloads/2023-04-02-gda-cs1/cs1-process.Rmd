...
```{r export original data, eval=FALSE}
write.csv(all_rides, file='original_rides.csv')
```

### Export the Cleaned Data
```{r export cleaned data, eval=FALSE}
write.csv(filtered_rides, file='cleaned_rides.csv')
```

### Export the Bad Data
```{r export bad data, eval=FALSE}
write.csv(removed_rides, file='removed_rides.csv')
```